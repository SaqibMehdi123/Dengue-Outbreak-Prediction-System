...
\begin{titlepage}
    ...
    {\large \textbf{Submission Date:} December 14, 2025}\\[1cm]
    
    {\normalsize \textbf{GitHub Repository:} \url{https://github.com/SaqibMehdi123/Dengue-Outbreak-Prediction-System}}\\[0.3cm]
    {\normalsize \textbf{Video Demo:} \url{https://drive.google.com/drive/folders/17ykPJbeb1BjaAjtbAs9IqG5dn5UyjkVs}}
